...
class ErrorType(Enum):
    ...
    # Export errors
    EXPORT_CREATION = "export_creation_error"
    EXPORT_PROCESSING = "export_processing_error"
    EXPORT_PROGRESS = "export_progress_error"
    EXPORT_RESULT = "export_result_error"
    EXPORT_DOWNLOAD = "export_download_error"
    EXPORT_HISTORY = "export_history_error"
    EXPORT_STATS = "export_stats_error"
    EXPORT_VALIDATION = "export_validation_error"
    EXPORT_TEMPLATE_CREATION = "export_template_creation_error"
    EXPORT_TEMPLATE_RETRIEVAL = "export_template_retrieval_error"
    EXPORT_TEMPLATE_UPDATE = "export_template_update_error"
    EXPORT_TEMPLATE_DELETION = "export_template_deletion_error"
    EXPORT_TEMPLATE_USE = "export_template_use_error"
    EXPORT_BULK = "export_bulk_error"
    EXPORT_CLEANUP = "export_cleanup_error"
    EXPORT_ESTIMATE = "export_estimate_error"
    EXPORT_FORMATS = "export_formats_error"
    EXPORT_TYPES = "export_types_error"
    EXPORT_DEFAULT_TEMPLATES = "export_default_templates_error"
    EXPORT_STATUS = "export_status_error"
    EXPORT_RECENT = "export_recent_error"
    
    # Cache errors
    CACHE_GET = "cache_get_error"
    CACHE_SET = "cache_set_error"
    CACHE_DELETE = "cache_delete_error"
    CACHE_CLEAR = "cache_clear_error"
    CACHE_STATS = "cache_stats_error"
    CACHE_HEALTH = "cache_health_error"
    
    # Rate limiting errors
    RATE_LIMIT_EXCEEDED = "rate_limit_exceeded_error"
    RATE_LIMIT_CONFIG = "rate_limit_config_error"
    RATE_LIMIT_STATS = "rate_limit_stats_error"
    RATE_LIMIT_CLEAR = "rate_limit_clear_error"
    RATE_LIMIT_BLOCK = "rate_limit_block_error"
    RATE_LIMIT_UNBLOCK = "rate_limit_unblock_error"
    
    # Logging errors
    LOGGING_STATS = "logging_stats_error"
    LOGGING_EXPORT = "logging_export_error"
    LOGGING_CLEAR = "logging_clear_error"
    LOGGING_HEALTH = "logging_health_error"
    LOGGING_TEST = "logging_test_error"
    LOGGING_CONFIG = "logging_config_error"
    
    # Database optimization errors
    DB_QUERY_OPTIMIZATION = "db_query_optimization_error"
    DB_QUERY_EXECUTION = "db_query_execution_error"
    DB_QUERY_CACHE = "db_query_cache_error"
    DB_BATCH_QUERY = "db_batch_query_error"
    DB_SLOW_QUERY = "db_slow_query_error"
    DB_PERFORMANCE_MONITORING = "db_performance_monitoring_error"
    DB_QUERY_PATTERN_ANALYSIS = "db_query_pattern_analysis_error"
    DB_TABLE_OPTIMIZATION = "db_table_optimization_error"
    DB_CONNECTION_POOL = "db_connection_pool_error"
    DB_QUERY_STATS = "db_query_stats_error"
    DB_QUERY_METRICS = "db_query_metrics_error"
    DB_INDEX_SUGGESTION = "db_index_suggestion_error"
    DB_PARTITION_SUGGESTION = "db_partition_suggestion_error"
    DB_QUERY_REWRITING = "db_query_rewriting_error"
    DB_QUERY_TIMEOUT = "db_query_timeout_error"
    DB_CONCURRENT_QUERY_LIMIT = "db_concurrent_query_limit_error"
